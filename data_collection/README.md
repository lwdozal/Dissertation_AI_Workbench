...
Before beginning, make sure you create an Instagram account. I created one just for this project.
...
Open the `RemoveDuplicates.py` and make sure the file being used as the content vairable matches your file. 

This will create a new file with the duplicates removed from your content file. 

This new file, *duplicates_removed.csv*, should have the paths to all the images that were downloaded. Some of these images might have downloaded with an error. We want to check if there are any missing from our scraping. 
