...
def first_image(hashtag, img_call, c):
	...
	df = pd.concat([s1,s2, s3,s4,s5,s6,s7,s8,s9,s10, s11, s13], axis=1)	#append df to existing csv (create one before running)
...
def download_allposts(hashtag):
	...
	# Check if Posts contains multiple images or videos; # multiple_images = nested_check()
...
if __name__ == "__main__":
	...
	# hashtag = '25N'
	# hashtag = "femicidioemergencianacional"
	# hashtag = "apartados8km"
	# hashtag = "UnDíaSinNosotras"
	# hashtag = "%23undíasinnosotras"
	# hashtag = "estadofeminicida"
	# hashtag = "ellassimerepresentan"
	# hashtag = "elNuevenadiesemueve"
	# hashtag = "FuimosTodas"
	...
	#different versions of hashtag to paste into browswer when instagram gets mad at you
	# url = 'https://instagram.com//explore/tags/' + hashtag + "/" #assign url
	# url = 'https://www.instagram.com/explore/search/keyword/?q=' + hashtag
	# url = "https://www.instagram.com/" + account
	# https://www.instagram.com/explore/search/keyword/?q=%23undíasinnosotras
  	# url = "https://www.instagram.com/explore/search/keyword/?q=%apartados8km"
